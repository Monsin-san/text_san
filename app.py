...
st.write("ステップ１はサイドバーに表示されています。まずは説明に従ってデータを入力してください。データを入力したら実行ボタンを押してください。")
execute_button = st.sidebar.button('実行')
